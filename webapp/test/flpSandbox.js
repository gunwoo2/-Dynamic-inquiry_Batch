		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "qr을 활용한 배치번호 조회",
									"targetURL": "#synceaqrbatch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceaqrbatch-display": {
								"semanticObject": "synceaqrbatch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.qrbatch",
									"url": sap.ui.require.toUrl("sync/ea/qrbatch")
								}
							}
						}
					}
